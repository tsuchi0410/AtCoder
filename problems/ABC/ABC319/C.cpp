...
int main(){
    ...
    do{
        ...
        fore(i, v){
            ...
            // 右斜め
            if((h == 0 and w == 0) or (h == 1 and w == 1) or (h == 2 and w == 2)){
                if(h == 0 and w == 0){
                    if(masu[1][1] != 0 and masu[2][2] != 0 and masu[1][1] == masu[2][2]){
                        flag = false;
                    }
                }
                if(h == 1 and w == 1){
                    if(masu[0][0] != 0 and masu[2][2] != 0 and masu[0][0] == masu[2][2]){
                        flag = false;
                    }
                }
                if(h == 2 and w == 2){
                    if(masu[0][0] != 0 and masu[1][1] != 0 and masu[0][0] == masu[1][1]){
                        flag = false;
                    }
                }
            }
            ...
            // 左斜め
            if((h == 0 and w == 2) or (h == 1 and w == 1) or (h == 2 and w == 0)){
               if(h == 0 and w == 2){
                    if(masu[1][1] != 0 and masu[2][0] != 0 and masu[1][1] == masu[2][0]){
                        flag = false;
                    }
                }
                if(h == 1 and w == 1){
                    if(masu[0][2] != 0 and masu[2][0] != 0 and masu[0][2] == masu[2][0]){
                        flag = false;
                    }
                }
                if(h == 2 and w == 0){
                    if(masu[0][2] != 0 and masu[1][1] != 0 and masu[0][2] == masu[1][1]){
                        flag = false;
                    }
                }
            }

                ...
                rep(l, 6){
                    rep(m, 6){
                        rep(n, 6){
                            ...
                            ll cnt2 = K;
                            ll na, nb, nc, nd, ne;
                            na = min(j + A[i + 1][0], (ll)5);
                            cnt2--;
                            if(cnt2 > 0){
                                nb = min(k + A[i + 1][1], (ll)5);
                            }else{
                                nb = 0;
                            }
                            cnt2--;
                            if(cnt2 > 0){
                                nc = min(l + A[i + 1][2], (ll)5);
                            }else{
                                nc = 0;
                            }
                            cnt2--;
                            if(cnt2 > 0){
                                nd = min(m + A[i + 1][3], (ll)5);
                            }else{
                                nd = 0;
                            }
                            cnt2--;
                            if(cnt2 > 0){
                                ne = min(n + A[i + 1][4], (ll)5);
                            }else{
                                ne = 0;
                            }

                            chmin(dp[i + 1][na][nb][nc][nd][ne], dp[i][j][k][l][m][n] + C[i + 1]);
                ...
                rep(l, 6){
                    rep(m, 6){
                        rep(n, 6){
                            ...
                            if(K == 3){
                                if((j >= P) and (k >= P) and (l >= P)){
                                    chmin(ans, dp[i][j][k][l][m][n]);
                                }
                            }
                            if(K == 4){
                                if((j >= P) and (k >= P) and (l >= P) and (m >= P)){
                                    chmin(ans, dp[i][j][k][l][m][n]);
                                } 
                            }
                            if(K == 5){
                                if((j >= P) and (k >= P) and (l >= P) and (m >= P) and (n >= P)){
                                    chmin(ans, dp[i][j][k][l][m][n]);
                                } 
                            }
                        }
